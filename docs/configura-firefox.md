...
- <b>browser.tabs.insertRelatedAfterCurrent</b> = false</br>
- <b>identity.fxaccounts.enabled</b> = false</br>
- <b>extensions.pocket.enabled</b> = false</br>
- <b>browser.preferences.moreFromMozilla</b> = false</br>
- <b>browser.download.alwaysOpenPanel</b> = false</br>
- <b>browser.download.animateNotifications</b> = false</br>
- <b>browser.download.saveLinkAsFilenameTimeout</b> = 0 (zero)</br>
- <b>layers.acceleration.force-enabled</b> = true</br>
- <b>gfx.webrender.all</b> = true</br>
- <b>media.ffmpeg.vaapi.enabled</b> = true</br>
- <b>media.ffvpx.enabled</b> = false</br>
- <b>media.navigator.mediadatadecoder_vpx_enabled</b> = true</br>
- <b>media.rdd-vpx.enabled</b> = false</br>
- <b>media.rdd-process.enabled</b> = false</br>
- <b>toolkit.legacyUserProfileCustomizations.stylesheets</b> = true</br>
- <b>browser.preferences.defaultPerformanceSettings.enabled</b> = false</br>
- <b>dom.ipc.processCount</b> = 2</br>
- <b>browser.cache.disk.enable</b> = false</br>
- <b>browser.cache.memory.capacity</b> e defina o valor 150000 = 150MB ou use o valor -1 para que o navegador ajuste automaticamente</br>
